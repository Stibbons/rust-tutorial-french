...
#CLOUD import cloud_sptheme as csp
...
# documentation.
# CLOUD: html_theme_options = { "roottarget": "index" }

# Add any paths that contain custom themes here, relative to this directory.
# CLOUD: html_theme_path = [csp.get_theme_dir()]
